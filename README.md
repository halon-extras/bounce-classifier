...
This plugin will query the [bounce-classifier](https://docs.halon.io/bounce-classifier/) service. It uses a internal cache of the normalized message. You can inspect the efficiency of the bounce-classifier cache using this command; ``halonctl hsl cache list``.
